...
fcpp = open('DFITCTraderApi.h', 'r')
ftask = open('xspeed_td_task.cpp', 'w')
fprocess = open('xspeed_td_process.cpp', 'w')
ffunction = open('xspeed_td_function.cpp', 'w')
fdefine = open('xspeed_td_define.cpp', 'w')
fswitch = open('xspeed_td_switch.cpp', 'w')
fheaderprocess = open('xspeed_td_header_process.h', 'w')
fheaderon = open('xspeed_td_header_on.h', 'w')
fheaderfunction = open('xspeed_td_header_function.h', 'w')
fwrap = open('xspeed_td_wrap.cpp', 'w')
