...
fcpp = open('GoldTradeApi.h', 'r')
ftask = open('ksgold_td_task.cpp', 'w')
fprocess = open('ksgold_td_process.cpp', 'w')
ffunction = open('ksgold_td_function.cpp', 'w')
fdefine = open('ksgold_td_define.cpp', 'w')
fswitch = open('ksgold_td_switch.cpp', 'w')
fheaderprocess = open('ksgold_td_header_process.h', 'w')
fheaderon = open('ksgold_td_header_on.h', 'w')
fheaderfunction = open('ksgold_td_header_function.h', 'w')
fwrap = open('ksgold_td_wrap.cpp', 'w')
