...
fcpp = open('USTPFtdcTraderApi.h', 'r')
ftask = open('femas_td_task.cpp', 'w')
fprocess = open('femas_td_process.cpp', 'w')
ffunction = open('femas_td_function.cpp', 'w')
fdefine = open('femas_td_define.cpp', 'w')
fswitch = open('femas_td_switch.cpp', 'w')
fheaderprocess = open('femas_td_header_process.h', 'w')
fheaderon = open('femas_td_header_on.h', 'w')
fheaderfunction = open('femas_td_header_function.h', 'w')
fwrap = open('femas_td_wrap.cpp', 'w')
